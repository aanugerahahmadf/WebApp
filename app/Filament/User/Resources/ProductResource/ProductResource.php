...
namespace App\Filament\User\Resources\ProductResource;
...
class ProductResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->content(view('User.components.product-catalog-grid.product-catalog-grid'))
            ->filters([
    ...
    {
        return [
            'index' => Pages\ManageProducts\ManageProducts::route('/'),
            'view' => Pages\ViewProduct\ViewProduct::route('/{record}'),
            'checkout' => Pages\CheckoutProduct\CheckoutProduct::route('/{record}/checkout'),
        ];
    }
